...
using MerchantsGuideToGalaxy.Core.CommandProcessor.Keywords;
...
namespace MerchantsGuideToGalaxy.Test
{
    internal class LexTest
    {
        ...
        {
            const string sentence = Operators.Is;
        ...
        {
            const string sentence = Qualifiers.QueryCommandQualifier;
        ...
        {
            const string sentence = Statements.How;
