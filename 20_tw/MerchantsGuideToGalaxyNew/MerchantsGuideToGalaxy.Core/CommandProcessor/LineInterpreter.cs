...
namespace MerchantsGuideToGalaxy.Core.CommandProcessor
{
    public class LineInterpreter
    {
        ...
        public CommandResult ParseAndExecute(string commandText)
        {
            ...
            {
                return new CommandResult { ResultText = e.Message, Success = false };
            }
            catch (Exception)
            {
                return new CommandResult { ResultText = ErrorMessages.HaveNoIdea, Success = false };
            }

            throw new NotSupportedException(ErrorMessages.CommandNotSupported);
        }
        ...
        private Command Parse()
        {
            ...
            throw new ParsingException(ErrorMessages.HaveNoIdea);
        }
